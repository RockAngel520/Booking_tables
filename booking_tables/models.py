...
class Table(models.Model):
    """Модель столика для бронирования"""

    number = models.PositiveIntegerField(
        unique=True, verbose_name="Номер столика", help_text="Укажите номер столика"
    )
    ...
    is_publish = models.BooleanField(
        verbose_name="Доступен к бронированию", default=True
    )
...
class Booking(models.Model):
    ...
    time = models.TimeField(
        verbose_name="Время посещения", help_text="Укажите время посещения"
    )
